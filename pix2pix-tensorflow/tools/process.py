...
parser.add_argument("--size", type=int, default=500, help="size to use for resize operation")
# combine
...
def run_caffe(src):
    ...
    if net is None:
        ...
        net = caffe.Net("/opt/caffe/examples/hed/hed/deploy.prototxt", "/opt/caffe/hed_pretrained_bsds.caffemodel", caffe.TEST)
